...
const Register = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Mock registration - redirect to feed
    navigate("/feed");
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-background-secondary px-4">
      <div className="w-full max-w-md animate-scale-in">
        ...
        <div className="bg-card rounded-card shadow-card p-8">
          <h1 className="text-page-title mb-2 text-center">Create account</h1>
          <p className="text-text-secondary text-center mb-8">Join HideLikes today</p>
